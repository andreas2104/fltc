  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <p className="text-xl text-gray-700 dark:text-gray-300">
        Bonjour, {userName}. Vous pouvez naviguer en utilisant le menu de gauche.
      </p>

      {loading ? (
        <div className="text-center text-lg text-gray-600 dark:text-gray-400">Chargement des données...</div>
      ) : error ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md transition-all duration-300 transform hover:scale-105">
            <h3 className="text-2xl font-semibold mb-2 text-blue-600">Total étudiants</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md transition-all duration-300 transform hover:scale-105">
            <h3 className="text-2xl font-semibold mb-2 text-red-600">Frais</h3>
